...
public class VistaMostrarProveedor extends JFrame implements IGUI {
	...
	public VistaMostrarProveedor(){
		...
		super("Leer Proveedor");
		Controlador.getInstance().registerView(Evento.MOSTRAR_PROVEEDOR, this);
		initGUI();
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add( new JLabel("Introduzca el ID del proveedor que desee leer"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MOSTRAR_PROVEEDOR, ID);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_PROVEEDOR_OK)
			...
			JOptionPane.showMessageDialog(this, "No se ha podido leer el proveedor");
	}
}