...
public class VistaAltaProveedores extends JFrame implements IGUI {
	
	public VistaAltaProveedores() {
		super("Alta Proveedor");
		Controlador.getInstance().registerView(Evento.ALTA_PROVEEDOR, this);
		initGUI();
	}
	...
	private void initGUI() {
		...
		panel.add(upPanel1);
		upPanel1.add( new JLabel("Introduzca los datos del proveedor que quiere añadir"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					TProveedores toc = new TProveedores(0, nombre, nif, true);
					Controlador.getInstance().accion(Evento.ALTA_PROVEEDOR, toc);
				} catch (Exception ex) {
