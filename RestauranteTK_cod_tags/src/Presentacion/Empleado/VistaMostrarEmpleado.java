...
public class VistaMostrarEmpleado extends JFrame implements IGUI {

	public VistaMostrarEmpleado() {
		super("Leer empleado");
		Controlador.getInstance().registerView(Evento.MOSTRAR_EMPLEADO, this);
		initGUI();
	}
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add(new JLabel("Introduzca el ID del empleado que desee leer"));
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_EMPLEADO_OK)
			...
			JOptionPane.showMessageDialog(this, "No se ha podido leer el empleado");
	}
}