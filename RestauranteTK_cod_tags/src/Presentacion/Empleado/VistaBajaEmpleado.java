...
public class VistaBajaEmpleado extends JFrame implements IGUI {
	...
	public VistaBajaEmpleado() {
		super("Baja Empleado");
		Controlador.getInstance().registerView(Evento.BAJA_EMPLEADO, this);
		initGUI();
	}
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add(new JLabel("Introduzca el ID del empleado que desee eliminar"));
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_BAJA_EMPLEADO_OK)
			JOptionPane.showMessageDialog(this, "Se ha eliminado correctamente el empleado con id " + (Integer) datos);
		else if (evento == Evento.RES_BAJA_EMPLEADO_KO)
