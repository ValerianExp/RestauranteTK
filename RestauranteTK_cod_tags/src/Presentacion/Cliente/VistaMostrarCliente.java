...
public class VistaMostrarCliente extends JFrame implements IGUI {
	...
	public VistaMostrarCliente(){
		...
		super("Leer Cliente");
		Controlador.getInstance().registerView(Evento.MOSTRAR_CLIENTE, this);
		initGUI();
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add( new JLabel("Introduzca el ID del cliente que desee leer"));
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_CLIENTE_OK)
			...
			JOptionPane.showMessageDialog(this, "No se ha podido leer el cliente");
	}
}