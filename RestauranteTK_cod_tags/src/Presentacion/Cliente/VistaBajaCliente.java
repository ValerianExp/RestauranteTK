...
public class VistaBajaCliente extends JFrame implements IGUI {
	...
	public VistaBajaCliente() {
		super("Baja Cliente");
		Controlador.getInstance().registerView(Evento.BAJA_CLIENTE, this);
		initGUI();
	}
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add(new JLabel("Introduzca el ID del cliente que desee eliminar"));
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if(FactoriaAbstractaNegocio.getInstance().createSACliente().read(ID)==null)
						throw new Exception("No se ha encontrado ningun Id");
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_BAJA_CLIENTE_OK)
			JOptionPane.showMessageDialog(this, "Se ha eliminado correctamente el cliente con id " + (Integer) datos);
