...
public class VistaMostrarProducto extends JFrame implements IGUI {

	public VistaMostrarProducto(){
		
		super("Leer Producto");
		Controlador.getInstance().registerView(Evento.MOSTRAR_PRODUCTO, this);
		initGUI();
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add( new JLabel("Introduzca el ID del producto que desee leer"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MOSTRAR_PRODUCTO, ID);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_PRODUCTO_OK)
			...
			JOptionPane.showMessageDialog(this, "No se ha podido leer el producto");
	}
}