...
public class VistaMostrarFactura extends JFrame implements IGUI {

	public VistaMostrarFactura(){
		
		super("Leer Factura");
		Controlador.getInstance().registerView(Evento.MOSTRAR_FACTURA, this);
		initGUI();
	...
	private void initGUI() {
		...
		panel.add(upPanel);
		upPanel.add( new JLabel("Introduzca el ID de la factura que desee leer"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					Controlador.getInstance().accion(Evento.MOSTRAR_FACTURA, ID);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_FACTURA_OK)
			...
			JOptionPane.showMessageDialog(this, "No se ha podido leer la factura");
	}
}