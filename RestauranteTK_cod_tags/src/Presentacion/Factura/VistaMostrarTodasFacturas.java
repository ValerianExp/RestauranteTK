...
public class VistaMostrarTodasFacturas extends JFrame implements IGUI {

	public VistaMostrarTodasFacturas() {
		super("Mostrar Facturas");
		Controlador.getInstance().registerView(Evento.MOSTRAR_TODAS_FACTURAS, this);
		initGui();
	}
	...
	private void initGui() {
		...
		panel.add(upPanel);
		upPanel.add(new JLabel("Confirme si quiere mostrar facturas"));
		...
		aceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				try {
					Controlador.getInstance().accion(Evento.MOSTRAR_TODAS_FACTURAS, null);
				} catch (Exception ex) {
	...
	public void actualizar(int evento, Object datos) {
		if (evento == Evento.RES_MOSTRAR_TODAS_FACTURAS_OK) {
		...
		} else if (evento == Evento.RES_MOSTRAR_TODAS_FACTURAS_KO)
